...
<hr />
      ...
      <h4 className="font-semibold text-center text-blue-dark mt-10 mb-2"> Te sirvió la información?</h4>
  ...
  <hr />
      ...
      <div className="flex justify-evenly mt-24 ">
        <div>
          <h4 className="text-blue-dark font-semibold mb-2">Artículos relacionados</h4>
        ...
        <div>
        <h4 className="text-blue-dark font-semibold mb-2" >Artículos más vistos</h4>
        <ol className="text-sm">
